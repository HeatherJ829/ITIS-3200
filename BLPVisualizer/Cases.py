...
TEST_CASES = {
    ...
    9: [("read","alice","emails.txt"), ("write","alice","username.txt"), ("read","alice","password.txt"), ("write","alice","emails.txt")], # Alice reads emails.txt then writes to username.txt, next she reads password.txt and finally writes to password.txt
